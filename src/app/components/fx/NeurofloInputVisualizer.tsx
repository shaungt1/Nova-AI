...
export interface NeurofloInputVisualizerHandle {
  trigger: () => void;
}
 ...
 *
 */
const NeurofloInputVisualizer = forwardRef<NeurofloInputVisualizerHandle, Props>(
...
export default React.memo(NeurofloInputVisualizer);